...
export const todosSlice = createSlice({
  ...
  reducers: {
    ...
    ...loadTodosReducer(todosAdapter),
    ...createTodoReducer(todosAdapter),
    ...removeTodoReducer(todosAdapter),
    ...updateTodoTitleReducer(todosAdapter),
    ...createTaskReducer(todosAdapter),
    ...removeTaskReducer(todosAdapter),
    ...updateTaskReducer(todosAdapter),
    ...reorderTodosReducer(),
    ...reorderTasksReducer(),
  },
});
